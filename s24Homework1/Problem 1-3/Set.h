...
///////////////////////////////////////////////////////////////////////
///  Problem 1
///   Determine which member functions of the Set class should be const member functions (because they do not modify the Set),
///   and change the class declaration accordingly.
////////////////////////////////////////////////////////////////////////
...
class Set
{
    ...
    private:
        ...
        ItemType m_array[DEFAULT_MAX_ITEMS]; // an array that can hold any type the based on the alias ItemType
};
#endif /* Set_h */
